...
final class NavigationHelperResult {
    final boolean success; final String code; final int userId; final int taskId; final int stackId;
    ...
    static NavigationHelperResult parse(String output) {
        ...
        return new NavigationHelperResult(ok,code,parseNonNegative(values.get("user")),parseNonNegative(values.get("task")),parseNonNegative(values.get("stack")),
