...
APP_PA="$(find_app_pa)" || { stop_safety "Current DoFun app_p_a not found"; exit 2; }
...
su -c "am force-stop com.dofun.variety; cat '$BACK/donor-original.jar' > '$TARGET'; sync" || { fail "Root restore command failed"; exit 1; }
